...
|---|---|---|---|
| RIN-01 | Receipt integrity | Must | Action receipts shall be append-only and immutable after creation. Users may archive, hide, or add annotations to receipts, but never modify the original receipt fields. |
